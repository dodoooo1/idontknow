...
/*
    ...
    public ProblemDetail handleLazyInitialization(
        ...
        return this.buildProblemDetail(HttpStatus.INTERNAL_SERVER_ERROR, AppConstants.API_DEFAULT_ERROR_MESSAGE);
    }
    ...
    public ResponseEntity<ProblemDetail> rootException(final RootException ex) {
        ...
        final ProblemDetail problemDetail =
                this.buildProblemDetail(
                        ex.getHttpStatus(), AppConstants.API_DEFAULT_REQUEST_FAILED_MESSAGE, ex.getErrors());
...
/*
    ...
    private String extractPersistenceDetails(final String cause) {
        ...
        String details = AppConstants.API_DEFAULT_ERROR_MESSAGE;
