...
start-api-with-docker-image: ## Run API with docker (don't forget to build the image locally before)
	@docker run --net host -e SPRING_PROFILES_ACTIVE="dev" -e SPRING_DATASOURCE_URL="jdbc:mysql://localhost:3306/api?useUnicode=true&characterEncoding=utf8&useSSL=false" api:0.0.1-SNAPSHOT
