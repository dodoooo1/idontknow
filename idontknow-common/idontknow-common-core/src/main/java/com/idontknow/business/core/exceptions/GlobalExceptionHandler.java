...
import com.idontknow.business.core.exceptions.types.RootException;
...
import static com.idontknow.business.core.constants.AppConstants.API_DEFAULT_ERROR_MESSAGE;
...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler {
   ...
   *     {@link BatchUpdateException}, {@link
  ...
  public ProblemDetail handleUsernameNotFoundException(final Exception ex) {
    log.info(ex.getMessage(), ex);
    final String cause = NestedExceptionUtils.getMostSpecificCause(ex).getLocalizedMessage();
    final String errorDetail = this.extractPersistenceDetails(cause);
    return this.buildProblemDetail(UNAUTHORIZED, errorDetail);
  }
