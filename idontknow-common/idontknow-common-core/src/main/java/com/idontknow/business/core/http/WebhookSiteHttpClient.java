...
import com.idontknow.business.core.utilities.WebClientUtils;
...
import static com.idontknow.business.core.http.WebhookSiteUrlEnum.POST;
import static com.idontknow.business.core.utilities.WebClientUtils.getErrorMessage;
...
public class WebhookSiteHttpClient {
    ...
    public WebhookSiteHttpClient(
        ...
        https:
        // resilience4j.readme.io/docs/circuitbreaker#create-and-configure-a-circuitbreaker
