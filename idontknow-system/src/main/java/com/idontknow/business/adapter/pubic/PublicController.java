...
import com.idontknow.business.rabbitmq.EventPublisher;
...
public class PublicController {
    ...
    public String publish() throws JsonProcessingException {
        this.eventPublisher.publish(this.exchange, this.routingKey, CoreJsonUtils.serialize(Map.of("test", "test")));
        return "published";
    }
